...
export function ProductCard({ product }: ProductCardProps) {
  return (
    <Link
      ...
      className="group relative overflow-hidden rounded-2xl border border-zinc-200/80 bg-white/95 shadow-sm shadow-zinc-200/40 hover:-translate-y-1 hover:border-amber-200 hover:shadow-xl hover:shadow-zinc-300/40"
    >
